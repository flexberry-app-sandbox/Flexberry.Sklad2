...
namespace IIS.Sklad2
{
    ...
    public class ЗаписьВНакладной : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sklad2.Накладная fНакладная;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Sklad2.Накладная.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Накладная"})]
        public virtual IIS.Sklad2.Накладная Накладная
        {
            get
            {
                ...
                IIS.Sklad2.Накладная result = this.fНакладная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьВНакладнойE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьВНакладнойE", typeof(IIS.Sklad2.ЗаписьВНакладной));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЗаписьВНакладной : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Sklad2.DetailArrayOfЗаписьВНакладной members)

        // *** End programmer edit section *** (IIS.Sklad2.DetailArrayOfЗаписьВНакладной members)
        ...
        /// </summary>
        public DetailArrayOfЗаписьВНакладной(IIS.Sklad2.Накладная fНакладная) : 
                base(typeof(ЗаписьВНакладной), ((ICSSoft.STORMNET.DataObject)(fНакладная)))
        {
        }
        
        public IIS.Sklad2.ЗаписьВНакладной this[int index]
        {
            get
            {
                return ((IIS.Sklad2.ЗаписьВНакладной)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Sklad2.ЗаписьВНакладной dataobject)
        {
