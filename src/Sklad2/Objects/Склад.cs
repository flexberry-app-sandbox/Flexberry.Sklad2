...
namespace IIS.Sklad2
{
    ...
    [View("СкладE", new string[] {
            ...
            "Сотрудник.Отчество as \'Отчество\'"}, Hidden=new string[] {
            "Сотрудник.Отчество"})]
    [AssociatedDetailViewAttribute("СкладE", "ТоварНаСкладе", "ТоварНаСкладеE", true, "", "Товар на складе", true, new string[] {
            ""})]
    [MasterViewDefineAttribute("СкладE", "Сотрудник", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Отчество")]
    ...
    public class Склад : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sklad2.Сотрудник fСотрудник;
        
        private IIS.Sklad2.DetailArrayOfТоварНаСкладе fТоварНаСкладе;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.Sklad2.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.Sklad2.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.Sklad2.DetailArrayOfТоварНаСкладе ТоварНаСкладе
        {
            get
            {
                ...
                {
                    this.fТоварНаСкладе = new IIS.Sklad2.DetailArrayOfТоварНаСкладе(this);
                }
                IIS.Sklad2.DetailArrayOfТоварНаСкладе result = this.fТоварНаСкладе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СкладE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладE", typeof(IIS.Sklad2.Склад));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СкладL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладL", typeof(IIS.Sklad2.Склад));
                }
            }
        }
    }
