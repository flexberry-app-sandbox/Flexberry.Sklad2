...
namespace IIS.Sklad2
{
    ...
    public class СтрокаЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sklad2.Заказ fЗаказ;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Sklad2.Заказ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        public virtual IIS.Sklad2.Заказ Заказ
        {
            get
            {
                ...
                IIS.Sklad2.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СтрокаЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СтрокаЗаказаE", typeof(IIS.Sklad2.СтрокаЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСтрокаЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Sklad2.DetailArrayOfСтрокаЗаказа members)

        // *** End programmer edit section *** (IIS.Sklad2.DetailArrayOfСтрокаЗаказа members)
        ...
        /// </summary>
        public DetailArrayOfСтрокаЗаказа(IIS.Sklad2.Заказ fЗаказ) : 
                base(typeof(СтрокаЗаказа), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.Sklad2.СтрокаЗаказа this[int index]
        {
            get
            {
                return ((IIS.Sklad2.СтрокаЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Sklad2.СтрокаЗаказа dataobject)
        {
